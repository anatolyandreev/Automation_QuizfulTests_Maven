...
import by.htp.quizful.pages.BasePage;
...
public class Steps {
	...
	public void fillPersonalDataSection(String name, String surname, String birthYear, String site, String company,
			String about) {
		profileActionPage = new ProfileActionPage(driver);
	...
	public void expandNotificationsBar() {
		profileActionPage = new ProfileActionPage(driver);
		profileActionPage.expandNotifications();
	}

	public boolean isOneOfNotificationCheckboxesEnabled() {
		profileActionPage = new ProfileActionPage(driver);
		if (profileActionPage.isDeliveryCheckboxEnabled() || profileActionPage.isNotificationsCheckboxEnabled())
			return true;
		return false;
	}
	...
	public void disableNotifications() {
		profileActionPage = new ProfileActionPage(driver);
		if (profileActionPage.isDeliveryCheckboxEnabled())
			profileActionPage.clickDeliveryCheckbox();
		if (profileActionPage.isNotificationsCheckboxEnabled())
			profileActionPage.clickNotificationsCheckbox();
		profileActionPage.clickNotificationosFormSaveButton();
	}

	public void signOut() {
		profileActionPage = new ProfileActionPage(driver);
		profileActionPage.clickLogoutButton();
	}

	public void expandPrivacyBar() {
		profileActionPage = new ProfileActionPage(driver);
		profileActionPage.expandPrivacy();
	}

	public void selectOnlyMePrivacyOption() {
		profileActionPage = new ProfileActionPage(driver);
		profileActionPage.clickOnlyMeRadioButton();
		profileActionPage.clickPrivacyFormSaveButton();
	}

	public boolean isOnlyMeOptionIsSelected() {
		profileActionPage = new ProfileActionPage(driver);
